...
func (h *MedicineHandler) ListByAvailable(ctx *gin.Context) {
	...
	res, err := h.service.ListByAvailable(&query)
	if err != nil {
		utils.ValidationErrorResponse(ctx, err)
		return
	}
...
func (h *MedicineHandler) ListByLowStock(ctx *gin.Context) {
	var query dto.MedicinePaginationQuery
	if err := ctx.ShouldBindQuery(&query); err != nil {
		utils.ValidationErrorResponse(ctx, err)
		return
	}
	res, err := h.service.ListByLowStock(&query)
	if err != nil {
		utils.ValidationErrorResponse(ctx, err)
		return
	}
...
func (h *MedicineHandler) ListInactive(ctx *gin.Context) {
	var query dto.MedicinePaginationQuery
	if err := ctx.ShouldBindQuery(&query); err != nil {
		utils.ValidationErrorResponse(ctx, err)
		return
	}
	res, err := h.service.ListByInactive(&query)
	if err != nil {
		utils.ValidationErrorResponse(ctx, err)
		return
	}
