...
func (s *cachedMedicalRecordService) invalidate(id uint) {
	ctx := context.Background()
	_ = s.redis.Delete(ctx, cache.MedicalRecordKey(id))
	_ = s.redis.DeleteByPattern(ctx, cache.PatternMedicalRecordAll)
}

func (s *cachedMedicalRecordService) invalidateAll() {
	_ = s.redis.DeleteByPattern(context.Background(), cache.PatternMedicalRecordAll)
}
