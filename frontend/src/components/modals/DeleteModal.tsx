...
interface DeleteModalProps {
  ...
  title?: string;
  description?: string;
  /** optional name of the item being deleted (e.g. username) */
  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        {children ? (
          <div className="text-sm leading-6 text-gray-500 dark:text-gray-400 mb-2">
            {children}
          </div>
        ) : (
        ...
        <div className="mt-8 flex w-full items-center justify-center gap-3">
          ...
          <button
            ...
            className="shadow-theme-xs flex justify-center rounded-lg bg-red-500 px-4 py-3 text-sm font-medium text-white hover:bg-red-600 disabled:opacity-50"
            disabled={loading}
          >
